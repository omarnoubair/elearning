                ...
                <table class="table table-striped custab ">
                    ...
                    <?php foreach ($CoursesList as $course) { ?>
                        ...
                        <br><tr>
                            ...
                            <td>
                                <a href="<?php echo BASE_URL . '/administration/deleteCourse/' . $course->id ?>" class= "btn btn-danger btn-xs" onclick="return confirm('Voulez-vous vraiment supprimer ce cours?');">
